...
## Expected Results
Upon running the make command, the program will generate the processed data files in the Data/Processed directory. The models are picked and stored as .joblib files in the src/models/trained_models directory. 
